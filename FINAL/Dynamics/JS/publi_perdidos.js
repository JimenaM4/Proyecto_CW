window.addEventListener('load', ()=> {
    ...
    btn_mensj.addEventListener("click",(e)=>{
        ...
        btn_enviar.addEventListener("click",(e)=>{
            ...
            if(!comen){
                ...
                window.location.href = `./publicacion_perdido.php?id=${id_publi.value}`;
            }else{
                datosForm = new FormData(formulario_coment);
                fetch("./mensajes_perdido.php",{
                    method: 'POST',
                    body: datosForm
                }).then((respuesta)=>{
    ...
    btn_coment.addEventListener("click",(e)=>{
        ...
        fetch("./desplegar_coment_perdido.php",{
            method: "POST",
            body: datosForm,
        })
        .then((respuesta)=>{
            ...
            datosJSON.forEach((a)=>{
                desp_coment.innerHTML +=` <div class="comentario" id="${a.ID_mensajeP}">
