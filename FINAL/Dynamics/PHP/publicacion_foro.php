<?php 
    ...
    if(!$conexion)
    {
        ...
        $sql =  "SELECT * FROM foro WHERE ID_foro = $_GET[id]";
        ...
        // echo $respuesta[0][1]."<br>";//ID foro
        // echo $respuesta[0][2]."<br>";//titulo
        // echo $respuesta[0][3]."<br>";//tema
        // echo $respuesta[0][4]."<br>";//descripcion
        // echo $respuesta[0][5]."<br>";//preguntas
        ...
        echo "<!DOCTYPE html>
            ...
            <head>
                ...
                <script src='../JS/publi_foro.js'></script>
